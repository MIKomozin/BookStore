                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'popular':
                                ...
                                break;
                            case'genre':
                                getData('/genres/' + $this.data('refreshid') + '/page', {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
                            ...
                            case'author':
                                ...
                                break;
                            case'tag':
                                getData('/tags/' + $this.data('refreshid') + '/page', {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                break;
                            case'search':
                                getData('/search/' + $this.data('refreshid') + '/page', {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                postData('/login', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Неверный пароль и\/или имя пользователя!' + '</div>');
                                        }
                                    }
                                })
                            }
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                ...
                                                break;
                                            case'recent':
                                                sendData('/books/recents')
                                                break;
                                            case'popular':
                                                sendData('/books/populars')
                                                break;
                                        }
                                    }
                                }
